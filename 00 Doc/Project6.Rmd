...
#![](./blending_Average Airtime of Planes Based on Plane's Year of Starting Service.png)
...
Second visualization produced using data blending - FT & plane

We are interested to see the average airtime for all the planes based on their age (Year). 
